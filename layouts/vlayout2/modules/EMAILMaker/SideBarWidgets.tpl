    ...
    <div class="quickWidgetContainer accordion">
        ...
        <div class="quickWidget">
            <div class="accordion-heading accordion-toggle quickWidgetHeader" data-target="#{$MODULE}_sideBar_Tools"
                 ...
                 data-widget-url="module=EMAILMaker&view=TemplateTools&templateid={$smarty.request.record}&from_view={$smarty.request.view}&from_templateid={$smarty.request.record}" >
                <span class="pull-left"><img class="imageElement" data-rightimage="{vimage_path('rightArrowWhite.png')}" data-downimage="{vimage_path('downArrowWhite.png')}" src="{vimage_path('rightArrowWhite.png')}" /></span>
            ...
            <div class="widgetContainer accordion-body collapse" id="{$MODULE}_sideBar_Tools" data-url="module=EMAILMaker&view=TemplateTools&templateid={$smarty.request.record}&from_view={$smarty.request.view}&from_templateid={$smarty.request.record}">
            </div>
        </div>
        {/if}
    </div>
